...
/* import: 'env' 'memory' */
extern THREAD wasm_rt_memory_t (*Z_envZ_memory);
/* import: 'env' 'table' */
extern THREAD wasm_rt_table_t (*Z_envZ_table);
...
extern void (*WASM_RT_ADD_PREFIX(Z__aesb_single_roundZ_viii))(u32, u32, u32);
